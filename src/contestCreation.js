if (secrets.rapidapiKey == "" ) {
  ...
  if (!sportspageResponse.error) {
    if (sportspageResponse.data['results']['0']['status'] === 'scheduled') {
      ...
      const awayTeam = (() => {
        if (teamLegend.find(x => x.leagueId === league && x.sportspageTeamName === awayTeamString)) {
      ...
      const homeTeam = (() => {
        if (teamLegend.find(x => x.leagueId === league && x.sportspageTeamName === homeTeamString)) {
  ...
  if (!jsonoddsResponseAll.error) {
    if (jsonoddsResponse) {
      ...
      const awayTeam = (() => {
        if (teamLegend.find(x => x.leagueId === league && x.jsonoddsTeamName === awayTeamString)) {
      ...
      const homeTeam = (() => {
        if (teamLegend.find(x => x.leagueId === league && x.jsonoddsTeamName === homeTeamString)) {
